...
(226, 'Azorius Keyrune', 'Artifact', NULL, 'RTR', 'Gray', '{3}', NULL, NULL, ': Add {W} or {U}.  {W}{U}: Azorius Keyrune becomes a 2/2 white and blue Bird artifact creature with flying until end of turn.  "The higher the mind soars, the greater its understanding of the law." -Isperia'),
(227, 'Chromatic Lantern', 'Artifact', NULL, 'RTR', 'Gray', '{3}', NULL, NULL, '  Lands you control have "{T}: Add one mana of any color."  {T}: Add one mana of any color.  Dimir mages put the lanterns to good use, creating shapeshifters and sleeper agents from mana foreign to them.'),
(228, 'Civic Saber', 'Artifact', 'Equipment', 'RTR', 'Gray', '{1}', NULL, NULL, '  Equipped creature gets +1/+0 for each of its colors.  Equip {1}  Those without a guild signet often display a different form of protection.'),
(229, 'Codex Shredder', 'Artifact', NULL, 'RTR', 'Gray', '{1}', NULL, NULL, ': Target player mills a card. (They put the top card of their library into their graveyard.)  {5}, {T}, Sacrifice Codex Shredder: Return target card from your graveyard to your hand.'),
(230, 'Golgari Keyrune', 'Artifact', NULL, 'RTR', 'Gray', '{3}', NULL, NULL, ': Add {B} or {G}.  {B}{G}: Golgari Keyrune becomes a 2/2 black and green Insect artifact creature with deathtouch until end of turn.  Like a single ant, it only hints at the colony below.'),
(231, 'Izzet Keyrune', 'Artifact', NULL, 'RTR', 'Gray', '{3}', NULL, NULL, ': Add {U} or {R}.  {U}{R}: Until end of turn, Izzet Keyrune becomes a 2/1 blue and red Elemental artifact creature.  Whenever Izzet Keyrune deals combat damage to a player, you may draw a card. If you do, discard a card.'),
(232, 'Pithing Needle', 'Artifact', NULL, 'RTR', 'Gray', '{1}', NULL, NULL, '  As Pithing Needle enters the battlefield, choose a card name.  Activated abilities of sources with the chosen name can''t be activated unless they''re mana abilities.  The fearful want the procedure before a blood festival. The guilty seek it afterward.'),
(233, 'Rakdos Keyrune', 'Artifact', NULL, 'RTR', 'Gray', '{3}', NULL, NULL, ': Add {B} or {R}.  {B}{R}: Rakdos Keyrune becomes a 3/1 black and red Devil artifact creature with first strike until end of turn.  The Rakdos use it for everything you can think of and plenty more than that.'),
(234, 'Selesnya Keyrune', 'Artifact', NULL, 'RTR', 'Gray', '{3}', NULL, NULL, ': Add {G} or {W}.  {G}{W}: Selesnya Keyrune becomes a 3/3 green and white Wolf artifact creature until end of turn.  A mark of unity when you want one; a fierce guardian when you need one.'),
(235, 'Street Sweeper', 'Artifact Creature', 'Construct', 'RTR', 'Gray', '{6}', 4, 6, '  Whenever Street Sweeper attacks, destroy all Auras attached to target land.  The sweepers roam endlessly, scrubbing away the refuse-and anything else too slow or too clumsy to get out of their way.'),
(236, 'Tablet of the Guilds', 'Artifact', NULL, 'RTR', 'Gray', '{2}', NULL, NULL, '  As Tablet of the Guilds enters the battlefield, choose two colors.  Whenever you cast a spell, if it''s at least one of the chosen colors, you gain 1 life for each of the chosen colors it is.  It is rumored the Azorius paid an exorbitant sum to ensure its symbol would appear at the top.'),
(237, 'Volatile Rig', 'Artifact Creature', 'Construct', 'RTR', 'Gray', '{4}', 4, 4, '  Trample  Volatile Rig attacks each combat if able.  Whenever Volatile Rig is dealt damage, flip a coin. If you lose the flip, sacrifice Volatile Rig.  When Volatile Rig dies, flip a coin. If you lose the flip, it deals 4 damage to each creature and each player.'),
